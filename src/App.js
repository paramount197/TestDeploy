  ...
  return (
    <>
      ...
      <Blurb Blurb="Hello and welcome to the TDP Events Webpage. Here you'll find all current and future TDP events.
                    You'll be able to confirm your attendance to the events via this webpage. Are you new user? Click 'Register' to sign up. 
                    If you are a returning user, click 'Sign In' to continue. For further guidance, see the 'Users-Guide'." />
